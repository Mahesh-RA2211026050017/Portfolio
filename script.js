...
const animateElements = document.querySelectorAll('.timeline-item, .project-card, .cert-card, .skill-category, .contact-item, .stat-item');
...
// Console message
console.log('%c👋 Welcome to Mahesh T\'s Portfolio!', 'color: #6366f1; font-size: 20px; font-weight: bold;');
